...
class TestIODriver(unittest.TestCase):

    # unit test
    def test_assignToArray(self):
        i = IODriver()
        blankBoardArray = [
            ['', '', '', '', '', '', '', ''],
            ['', '', '', '', '', '', '', ''],
        ...
        self.assertEqual(i.assignToArray(blankBoardArray, charList1, 0), boardArray1)
